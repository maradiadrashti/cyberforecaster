...
export default function App() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      // NOTE: generateAlert() is intentionally NOT called here.
      // Fake attack alerts must NEVER be injected into the live pipeline.
      // Alerts are only generated by real captured traffic via the backend.
    }, 1800);
